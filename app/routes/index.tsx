            ...
            <div className="relative bg-slate-200 px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pb-20 lg:pt-32">
              ...
              <div className="mx-auto mt-10 max-w-sm text-slate-900 sm:flex sm:max-w-none sm:justify-center pb-8">
                {(
                  <Link
                    to="/boards"
                    className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium font-mono shadow-sm hover:bg-blue-100 sm:px-8"
                  >
                    Landing Page
                  </Link>
                )}
              ...
              <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                {(
                  <Link
                    to="/admin"
                    className="flex items-center justify-center rounded-md border border-transparent bg-yellow-400 px-4 py-3 text-base font-medium font-mono shadow-sm hover:bg-blue-100 sm:px-8"
                  >
                    Admin Portal
                  </Link>
                )}
